 ...
 */
    ...
    public void paintComponent(Graphics g) {
        ...
        drawCellsNumbers(g2d, cellWidth, cellHeight);
    ...
    private void drawCellsNumbers(Graphics2D g2d, int cellWidth, int cellHeight) {
        ...
        for (Rectangle cell : cells) {
            ...
            //g2d.setColor(Color.red);
            drawPlayerPos(i, g2d, cell, cellWidth, cellHeight);
    ...
    private void drawPlayerPos(int i, Graphics2D g2d, Rectangle cell, int cellWidth, int cellHeight) {
